...
services --enabled=chronyd,lirc,NetworkManager,restorecond,yum-updatesd --disabled=capi,iprdump,iprinit,iprupdate,iscsi,iscsid,isdn,libvirtd,multipathd,netfs,network,nfs,nfslock,pcscd,rpcbind,rpcgssd,rpcidmapd,rpcsvcgssd,sendmail,sm-client,sshd
...
repo --name="JMiahMan %%KP_VERSION%%" --baseurl=http://127.0.0.1/korora/rpms/test/%%KP_VERSION%%/%%KP_BASEARCH%%/ --cost=9
